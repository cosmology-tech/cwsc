...
export declare class CWScriptParser extends Parser {
    ...
    static readonly RULE_fnType = 30;
    static readonly RULE_typeLens = 31;
    static readonly RULE_typePath = 32;
    static readonly RULE_typeVariant = 33;
    static readonly RULE_typeDefn = 34;
    static readonly RULE_structDefn = 35;
    static readonly RULE_typeAliasDefn = 36;
    static readonly RULE_fnDefn = 37;
    static readonly RULE_annot = 38;
    static readonly RULE_callOptions = 39;
    static readonly RULE_stmt = 40;
    static readonly RULE_debugStmt_ = 41;
    static readonly RULE_letStmt_ = 42;
    static readonly RULE_constStmt_ = 43;
    static readonly RULE_identBinding_ = 44;
    static readonly RULE_let_binding = 45;
    static readonly RULE_assignStmt_ = 46;
    static readonly RULE_assignLHS = 47;
    static readonly RULE_expr = 48;
    static readonly RULE_closureParams = 49;
    static readonly RULE_closure = 50;
    static readonly RULE_block = 51;
    static readonly RULE_tryCatchElseExpr_ = 52;
    static readonly RULE_catchClause = 53;
    static readonly RULE_arg = 54;
    static readonly RULE_memberVal = 55;
    static readonly RULE_literal = 56;
    static readonly RULE_ifStmt_ = 57;
    static readonly RULE_elseClause = 58;
    static readonly RULE_forStmt_ = 59;
    static readonly RULE_ident = 60;
    static readonly RULE_reservedKeyword = 61;
...
export declare class FnTContext extends TypeExprContext {
    fnType(): FnTypeContext;
    constructor(ctx: TypeExprContext);
    enterRule(listener: CWScriptParserListener): void;
    exitRule(listener: CWScriptParserListener): void;
...
export declare class AnnotBlockStmtContext extends StmtContext {
    annot(): AnnotContext;
    block(): BlockContext;
...
export declare class DebugStmtContext extends StmtContext {
    _annot: AnnotContext;
    _ann: AnnotContext[];
    debugStmt_(): DebugStmt_Context;
    annot(): AnnotContext[];
...
export declare class DebugStmt_Context extends ParserRuleContext {
    DEBUG(): TerminalNode;
